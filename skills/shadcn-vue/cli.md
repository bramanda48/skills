...
| `iconLibrary`        | `string`  | Icon library for CLI-generated components — one of `lucide`, `tabler`, `hugeicons`, `phosphor`, `remixicon`. No `iconify` option; swap to `@iconify/vue` after adding (see [icons.md](./rules/icons.md)) |
